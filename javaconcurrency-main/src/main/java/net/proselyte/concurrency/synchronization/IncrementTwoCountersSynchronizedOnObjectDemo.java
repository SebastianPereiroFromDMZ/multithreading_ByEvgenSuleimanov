...
public class IncrementTwoCountersSynchronizedOnObjectDemo {
    //этот класс и IncrementCounterSynchronizedBlockDemo класс показывают разницу во времени выполнении кода:
    //здесь в этом клессе есть 2 синхронизованных метода инкремента и меют разные обькты монитора
    //поэтому каждый поток работает со своим обьектом монитора и не мешают друг другу, поэтому время выполнения кода будет быстрее
