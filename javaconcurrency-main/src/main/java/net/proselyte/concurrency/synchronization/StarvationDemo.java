...
public class StarvationDemo {
    ...
    public static void main(String[] args) {
        ...
        thread3.start();
        thread4.start();
        // Here thread5 have to wait because of the  Здесь thread5 придется подождать из-за
        // other thread. But after waiting for some  другого потока. Но после некоторого ожидания
        // interval, thread5 will get the chance of  , поток5 получит возможность
        // execution. It is known as Starvation      исполнение. Это известно как голодание
